...
// import '../../../services/storage.dart' as myStroage;
...
//   InAppWebViewController? webcontroller; // 使用可空类型
...
//     print("WebController has been initialized.");
//   }
...
//                 //   showCustomSnackbar(
//                 //       message:
//                 //           'Scanning failed, please scan the correct QR code.',
//                 //       status: '3');
//                 //   return;
//                 // }
//                 parseScanUrl(data);
...
//   Future<void> handleScanResult(String v) async {
//     if (webcontroller == null) {
//       print('WebController is not initialized yet.');
//       return; // 提前返回，避免后续代码执行
//     }

//     try {
//       String? token = await myStroage.Storage.getData('token');
...
//       print("==================================");
//       print(uriWithToken);
//       await webcontroller!.loadUrl(urlRequest: URLRequest(url: uriWithToken));
//       print("==================================");
//     } catch (e) {
//       print("Error in handleScanResult: $e");
//     }
//   }

//   Future<void> onFileUploadRequested() async {
//     containerAdd();
//   }
